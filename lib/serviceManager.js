...
`;
    ...
    try {
        console.log(`Create service file : ${servicePath}`);
        ...
        console.error(`Error while create service file : ${error.message}`);
        throw error;
    }

    try {
        console.log(`Enable and start : ${serviceName}`);
        ...
        console.error(`Error while enabling/starting: ${error.message}`);
        throw error;
    }
}
...
// Fonction pour configurer le service Tezos Baker avec ou sans encryption
...
`;
    ...
    try {
        console.log(`Activation et démarrage du service : ${alias}`);
        execSync(`sudo systemctl enable ${alias}`);
        execSync(`sudo systemctl start ${alias}`);
        console.log(`Service ${alias} démarré.`);
    } catch (error) {
