...
// Fonction pour configurer le service Tezos Baker sans clé encryptée
async function configureBakerService(dataDir, rpcPort, serviceName, alias) {
...
// Fonction pour configurer le service Tezos Baker avec clé encryptée
async function configureBakerServiceWithEncryption(dataDir, rpcPort, serviceName, alias, passwordFilePath) {
    const protocolHash = await getCurrentProtocol(rpcPort);
