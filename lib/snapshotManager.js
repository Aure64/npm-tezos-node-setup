...
// Function to wait for the identity file to be created
...
// Function to handle an existing directory if it cannot be removed automatically
async function handleExistingDirectory(dataDir) {
    console.log(`The directory ${dataDir} already exists.`);

    try {
        // Attempt to remove the directory with sudo
...
// Function to import a snapshot into the node
...
// Function to get the sizes of available snapshots
